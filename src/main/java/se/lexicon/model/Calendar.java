...
public class Calendar {
    ...
    public Calendar(int calendarId, String title, String username) {
        this(title);
    ...
    public Calendar(int id, String title, String username, List<Meeting> meetings, int calendarId) {
        this(calendarId, title, username);
        this.id = id;
