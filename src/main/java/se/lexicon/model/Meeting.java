...
public class Meeting {
    ...
    public Meeting(int meetingId, String title, LocalDateTime startTime, LocalDateTime endTime, String description) {
        this.title = title;
    ...
    public Meeting (int id, String title, String description, String start, String end, String location, String username) {
        this.id = id;
        this.title = title;
        this.description = description;
        this.startTime = LocalDateTime.parse(start);
        this.endTime = LocalDateTime.parse(end);
        this.calendar = new Calendar(0, location, username);
        timeValidation();
    }
